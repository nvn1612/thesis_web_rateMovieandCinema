...
const { addMovieRating,getMovieRatings,deleteMovieRating,getFakeOrReportedMovieRatings,updateFakeandReportRating,reportMovieRating,getMovieRatingById  } = require('../controllers/movieRatingController');
